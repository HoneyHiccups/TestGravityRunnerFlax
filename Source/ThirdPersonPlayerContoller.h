...
API_FIELD() ScriptingObjectReference<Actor> RayCaster1;
API_FIELD() ScriptingObjectReference<Actor> RayCaster2;
API_FIELD() ScriptingObjectReference<Actor> RayCaster3;
float lookSens = 0.005f;
...
Vector3 WishDir;
Vector3 HorzialtalPlane = Vector3(1,0,0);
...
void RayCasterFromFeetToMakePlane(); /*Only use thes with thes*/ 
...
protected:
    ...
    Vector2 CamreaRotStack = Vector2::Zero; 
    SudoPlane WorkingPlaneStruct;
public:
    bool bcanjump = false;
